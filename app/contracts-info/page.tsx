    ...
    return (
        <main className="min-h-screen bg-black text-white">
            ...
            >
                ...
                {[
                    { num: '02', title: 'Liquidity Pool', desc: 'Holds all investor USDC. Manages shares, tracks allocations to funded traders, enforces liquidity protection rules.' },
                    ...
                    { num: '04', title: 'Payout Contract', desc: 'Handles profit splits for funded traders. Distributes 80% to trader, 15% to pool, 5% to platform treasury.' },
                    { num: '05', title: 'Proxy Governance Contract', desc: 'Enables traditional investors without Web3 wallets to participate in governance through a designated agent system.' },
                ].map((contract) => (
                    <div key={contract.num} className="border border-gray-800 rounded-2xl p-8 opacity-60">
            ...
            >
                ...
                <p className="text-gray-400 leading-relaxed max-w-2xl mx-auto mb-6">
                    ...
                    The audit report will be published here.
                </p>
